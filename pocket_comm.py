...
from pocket_comm import PocketItem, Pocket, clean_pdf_filename
import readline
import shutil
import subprocess as sp
from urllib.parse import urlparse
from starter_program import OPEN_COMMAND
from starter_program import PERCOL_COMMAND, SAVE_PDF_DIR
                ...
                case _:
                    ...
                    match cmd:
                        ...
                        case "p":
                            ...
                            savefilename=clean_pdf_filename(f"{formatted_date} {self.items[item_id].given_title}.pdf")
                            sp.Popen(
                                [PERCOL_COMMAND, "pdf", "--css", "a:after { display: none }", f"--output={SAVE_PDF_DIR}/{savefilename}", self.items[item_id].given_url],
                                stdout=sp.DEVNULL,
                                stderr=sp.DEVNULL,
                            )
                            #self.pocket.request_delete(item_id)
